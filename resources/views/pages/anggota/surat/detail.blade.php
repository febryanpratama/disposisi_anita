...
<div class="container-xxl flex-grow-1 container-p-y">
   <div class="row">
      ...
      <div class="col-md-6" style="text-align: right">
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahFoto">Tambah Foto Lapangan</button>
...
<div class="modal fade" id="tambahFoto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <form action="{{ url('anggota/surat/'.$data->id.'/foto-lapangan') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="surat_id" value="{{ $data->id }}">
            <div class="modal-body">
                <div class="row">
