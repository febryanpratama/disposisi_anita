                        ...
                        <div class="timeline-event pb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @elseif($item->name == 'Walikota')
                                        Catatan: {{ $data->catatan_walikota }}
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <form action="{{ url('walikota/surat/'.$data->id.'/ubah') }}" method="POST">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea class="form-control" rows="5" name="catatan_walikota" placeholder="Catatan"></textarea>
                </div>
                </div>
            </div>
