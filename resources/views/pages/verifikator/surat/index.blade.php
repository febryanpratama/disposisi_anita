                    ...
                    <tbody>
                        @foreach ($data as $item=>$key)
                            <tr class="text-center">
                                ...
                                <td class="d-flex">
                                    <a href="{{ url('verifikator/surat/'.$key->id) }}" class="btn btn-primary btn-sm m-1" title="Detail Surat">
                                    ...
                                    <div class="dropdown m-1">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="{{ url('verifikator/surat/'.$key->id.'/setuju') }}">Setuju</a></li>
                                            <li><a class="dropdown-item" href="{{ url('verifikator/surat/'.$key->id.'/tolak') }}">Tolak</a></li>
                                        </ul>
                                    </div>
