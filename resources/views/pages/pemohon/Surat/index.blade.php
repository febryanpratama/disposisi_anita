                    ...
                    <tbody>
                        ...
                        {{-- {{ dd($key) }} --}}
                            <tr class="text-center">
                                ...
                                <td class="d-flex">
                                    <a href="{{ url('pemohon/surat/'.$key->id) }}" class="btn btn-outline-primary btn-sm m-1" title="Detail Proposal">
                ...
                <div class="modal-body">
                    ...
                    <form id="editUserForm" class="row g-3" method="POST" action="{{ url('pemohon/surat') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="jumlah_biaya" id="rupiah" class="form-control" placeholder="Jumlah Biaya" />
                        </div>
