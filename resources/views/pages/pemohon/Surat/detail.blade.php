...
<div class="modal fade" id="pertanggunjawaban" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Dokumen Pertanggungjawaban</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <form action="{{ url('pemohon/pertanggungjawaban') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="surat_id" value="{{ $data->id }}">
            <div class="modal-body">
                <div class="row">
                <div class="col-md-12 mt-1">
                    ...
                    <small class="text-danger">Silahkan upload bukti pertanggungjawaban yang telah ditandatangani</small>
                </div>
                </div>
            </div>
            <div class="modal-footer">
